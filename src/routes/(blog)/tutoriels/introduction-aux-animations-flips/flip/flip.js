...
class Flip {
	...
	updateOptions() {
		this.options = Object.assign(
			{},
			defaultOptions,
			typeof this.originalOptions === 'function' ? this.originalOptions() : this.originalOptions
		);
	}
	...
	play() {
		console.log(JSON.stringify(this._first.boundingBox), JSON.stringify(this._last.boundingBox));
		this.updateOptions();
